// worker-admin.js
// Admin Worker entry — full routes including admin/invoice with heavy deps
// Bundle stays ~9MB but admin traffic is much lower → cold-start rarely matters

import app from './server-admin.js';
